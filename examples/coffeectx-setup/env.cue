// Full declarative coffeectx setup for Claude. #Main composes the Claude agent
// target and the coffeectx feature, then writes data into the shared namespaces:
// it generates ~/.coffeecode/config.yaml, installs skills/jobs, and feeds
// agent.mcps so Claude registers the MCP server.
//
